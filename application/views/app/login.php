...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
      <div class="hero-unit">
        <h2><?php echo $judul_lengkap.' '.$instansi; ?></h2>
        <p>Sistem Informasi Kepegawaian Uni Indonesia Kawasan Barat merupakan sebuah aplikasi untuk melakukan manajemen data kepegawaian berstatus <i>mission</i> di Kantor Pusat GMAHK Uni Indonesia Kawasan Barat. Silahkan masukkan <i>username</i> dan <i>password</i> anda untuk mulai untuk melakukan manajemen atau pengolahan data kepegawaian sesuai dengan hak akses yang anda miliki.</p>
